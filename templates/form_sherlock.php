...
if ( is_user_logged_in() ) {
    ...
    $registered_users = SkyEng_FormOptions::getOption('sherlock');
...
?>
<div class="subscribe_form holmes">

    <div class="title">
        Учите английский по сериалу «Шерлок». Это бесплатно
    </div>

    <div class="sub_title">
        Email-курс с разбором каждой серии и упражнениями для тренировки
    </div>
    ...
    <div class="input_area">
        ...
        <div class="submit_button_cont">
            <div class="submit_button" onclick="submitForm( this, 'sherlock')">
